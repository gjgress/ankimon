...
)  # /var/home/uwu/Documents/ankimon
ANKIMON_SRC_PARENT_DIR = os.path.join(
    ANKIMON_ROOT_DIR, "src"
)  # /var/home/uwu/Documents/ankimon/src

# ANKIMON_SRC_DIR is still needed for globbing python files and for Ankimon mock
ANKIMON_SRC_DIR = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "..", "src", "Ankimon")
)
