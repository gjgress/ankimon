...
def create_menu_actions(
    ...
    if database_complete:
        ...
        if pokecollection_win is not None:
            pokecol_action = QAction(mw.translator.translate("show_collection_button"), mw.form)
        ...
        # Pokémon PC
        pokemon_pc_action = QAction("Pokémon PC", mw.form)
        ...
        # Ankimon Window
        ankimon_window_action = QAction(mw.translator.translate("open_ankimon_window_button"), mw.form)
        ...
        # Itembag
        itembag_action = QAction(mw.translator.translate("itembag_button"), mw.form)
        ...
        achievement_bag_action = QAction(mw.translator.translate("achievements_button"), mw.form)
        ...
        pokemon_showdown_action = QAction(mw.translator.translate("open_showdown_teambuilder_button"), mw.form)
        ...
        # Export to Showdown
        export_main_to_showdown = QAction(mw.translator.translate("export_main_pokemon_button"), mw.form)
        ...
        export_all_to_showdown = QAction(mw.translator.translate("export_all_pokemon_button"), mw.form)
        ...
        # Flexing Collection
        flex_pokecoll_action = QAction(mw.translator.translate("export_all_pokemon_to_pokepaste_button"), mw.form)
        ...
        pokedex_action = QAction(mw.translator.translate("open_pokedex_button"), mw.form)
    ...
    # Effectiveness chart
    eff_chart_action = QAction(mw.translator.translate("eff_chart_button"), mw.form)
    ...
    gen_and_poke_chart_action = QAction(mw.translator.translate("gen_chart_button"), mw.form)
    ...
    # Join Discord
    join_discord_action = QAction(mw.translator.translate("join_discord_button"), mw.form)
    ...
    open_leaderboard_action = QAction(("Ankimon Leaderboard"), mw.form)
    ...
    # Credits
    credits_action = QAction(mw.translator.translate("ankimon_credits_button"), mw.form)
    credits_action.setMenuRole(QAction.MenuRole.NoRole)
    credits_action.triggered.connect(credits.show_window)
    help_menu.addAction(credits_action)

    # About and License
    about_and_license_action = QAction(mw.translator.translate("ankimon_about_and_license_button"), mw.form)
    ...
    # Help Guide
    help_action = QAction(mw.translator.translate("open_help_guide_button"), mw.form)
    ...
    # Report Bug
    report_bug_action = QAction(mw.translator.translate("report_bug_button"), mw.form)
    ...
    # Rate Addon
    rate_action = QAction(mw.translator.translate("rate_this_button"), mw.form)
    ...
    # Version
    version_action = QAction(mw.translator.translate("ankimon_version_button"), mw.form)
    version_action.setMenuRole(QAction.MenuRole.NoRole)
    version_action.triggered.connect(version_dialog.open)
    help_menu.addAction(version_action)

    config_action = QAction(mw.translator.translate("ankimon_settings_button"), mw.form)
    ...
    if debug is True:
        data_window_action = QAction(mw.translator.translate("ankimon_data_button"), mw.form)
        ...
        tracker_window_action = QAction(mw.translator.translate("ankimon_tracker_button"), mw.form)
    ...
    ankimon_logger_action = QAction(mw.translator.translate("logger_button"), mw.form)
    ...
    ankimon_trainer_card_action = QAction(mw.translator.translate("trainer_card_button"), mw.form)
    ...
    ankimon_trainer_card_action.triggered.connect(lambda: TrainerCardGUI(trainer_card, settings_obj, parent=mw.form))
    profile_menu.addAction(ankimon_trainer_card_action)

    # Add AnkimonShop Action to toggle the shop
    shop_manager_action = QAction(mw.translator.translate("item_shop_button"), mw.form)
    ...
    choose_trainer_sprite_action = QAction(mw.translator.translate("choose_trainer_sprite_button"), mw.form)
    ...
    pokemon_team_action = QAction(mw.translator.translate("choose_pokemon_team_button"), mw.form)
    ...
    file_check_action = QAction(mw.translator.translate("ankimon_file_checker_button"), mw.form)
    ...
    file_check_action = QAction(mw.translator.translate("ankimon_leaderboard_credentials_button"), mw.form)
    file_check_action.setMenuRole(QAction.MenuRole.NoRole)
    file_check_action.triggered.connect(show_api_key_dialog)
    mw.pokemenu.addAction(file_check_action)

    downloader_action = QAction(mw.translator.translate("download_resources_button"), mw.form)
